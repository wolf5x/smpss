<?php /* Smarty version 2.6.26, created on 2013-08-17 01:03:03
         compiled from simpla/stockout/addchoose.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'get_url', 'simpla/stockout/addchoose.html', 73, false),)), $this); ?>
<div>
	<h2>添加商品</h2>
	<div class="clear"></div>
...
$(function() {
	$("#btn_yes").click(function(){
		$.ajax({
			type: "POST",
			url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=ajaxaddyes'), $this);?>
",
			dataType: "json",
