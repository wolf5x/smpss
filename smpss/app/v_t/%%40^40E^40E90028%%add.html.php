<?php /* Smarty version 2.6.26, created on 2013-08-17 00:53:59
         compiled from simpla/stockout/add.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'get_url', 'simpla/stockout/add.html', 11, false),)), $this); ?>
	...
	<div class="content-box">
		<div class="content-box-header">
			...
			<ul class="content-box-tabs">
				<li><a href="<?php echo smarty_function_get_url(array('rule' => "/stockout/index"), $this);?>
">出库单管理</a></li>
...
">商品退货</a></li> -->
		...
		<div class="content-box-content">
			<div class="tab-content default-tab" id="tab1">
				<div class="form">
					<form action="<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=out'), $this);?>
...
" class="text-input" size='60' ondblclick="$(this).autocomplete('search','')"/><a href="javascript:;" tabindex="-1" id="customer_name_sel">&nbsp;▼&nbsp;</a>
								...
								<tr>
									...
									<td colspan="3"><textarea name="stockout_note" id="stockout_note" class="text-input textarea"><?php echo $this->_tpl_vars['info']['index']['stockout_note']; ?>
</textarea></td>
								</tr>
							</table>
...
<script type="text/javascript">
	...
	$(function(){
		$('#jqlist').jqGrid({
			//caption: '出库商品列表',
			mtype: "POST",
			url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=ajaxgetlist'), $this);?>
",
			editurl: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=ajaxeditrow'), $this);?>
",
			//editurl: 'clientArray',
			datatype: "json",
		...
		cname = $("#customer_name").autocomplete({
			delay: 0,
			  ...
			  source: function(request, response){
				  $.ajax({
					  url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=au&autype=cus'), $this);?>
",
				  dataType: "json",
				  data: {
					  prefix: request.term,
		...
		$("#out_btn").click(function(){
			if(confirm("确认出库?")) {
				$.ajax({
					type: "post",
					dataType: "json",
					url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=ajaxout'), $this);?>
",
					...
					success: function(rsp) {
								 ...
								 if(errcode == 0){
									 ...
									 var u = "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=print&sid=${}'), $this);?>
";
									 u = u.replace("\${}",rsp.stockout_sn);
									 //window.location.href = u;
									 $().message("出库成功!");
									 window.location.href = "<?php echo smarty_function_get_url(array('rule' => '/stockout/index'), $this);?>
";
									 newWindow(u);
								 } else{
									 $().message("出库失败: " +  errmsg);
...
function addRow() {
	$.fancybox({
		'type':'ajax',
		'href':"<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=ajaxaddrow'), $this);?>
"
	});
}
function clearList() {
	...
	if(false && sels==""){
		...
		if(confirm("确定清空？")) {
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=ajaxclr'), $this);?>
",
				//data: "ids="+sels,
				befordSend: function() {
					$().message("处理中..");
...
function g_oneditfunc(id, iRow, iCol, e) {
	...
	$("#"+id+"_goods_sn").autocomplete({
		...
		source: function(request, response){
			$.ajax({
				url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=au&autype=list'), $this);?>
",
			dataType: "json",
			data: {
				prefix: request.term,
		...
		select: function( event, ui ) {
					$.ajax({
						url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=au&autype=ginfo'), $this);?>
",
					dataType: "json",
					data: {
						goods_id: ui.item.id
...
function deleteRow(id) {
	if(confirm("确定移除该商品?")) {
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "<?php echo smarty_function_get_url(array('rule' => '/stockout/stockout','data' => 'ac=ajaxdelrow'), $this);?>
",
			data: {
				goods_id: id
			},
