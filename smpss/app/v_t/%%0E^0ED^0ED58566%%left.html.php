<?php /* Smarty version 2.6.26, created on 2013-08-17 00:53:51
...
" class="<?php if ($this->_tpl_vars['inpath'][2] == $this->_tpl_vars['k']): ?>current<?php endif; ?>"><?php echo $this->_tpl_vars['items']; ?>
	...
	<?php endif; ?>
	<?php if ($this->_tpl_vars['menu']['stockin']): ?>
      <li> <a href="javascript:;" class="nav-top-item <?php if ($this->_tpl_vars['inpath'][1] == 'stockin'): ?>current<?php endif; ?>">进货管理</a>
        <ul>
            <?php $_from = $this->_tpl_vars['menu']['stockin']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['items']):
?>
            <li><a href="<?php echo smarty_function_get_url(array('rule' => '/stockin/'), $this);?>
<?php echo $this->_tpl_vars['k']; ?>
" class="<?php if ($this->_tpl_vars['inpath'][2] == $this->_tpl_vars['k']): ?>current<?php endif; ?>"><?php echo $this->_tpl_vars['items']; ?>
</a></li>
            <?php endforeach; endif; unset($_from); ?>
	...
	<?php endif; ?>
	<?php if ($this->_tpl_vars['menu']['stockout']): ?>
      <li> <a href="javascript:;" class="nav-top-item <?php if ($this->_tpl_vars['inpath'][1] == 'stockout'): ?>current<?php endif; ?>">出货管理</a>
        <ul>
            <?php $_from = $this->_tpl_vars['menu']['stockout']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['items']):
?>
            <li><a href="<?php echo smarty_function_get_url(array('rule' => '/stockout/'), $this);?>
<?php echo $this->_tpl_vars['k']; ?>
" class="<?php if ($this->_tpl_vars['inpath'][2] == $this->_tpl_vars['k']): ?>current<?php endif; ?>"><?php echo $this->_tpl_vars['items']; ?>
</a></li>
            <?php endforeach; endif; unset($_from); ?>
	...
	<?php endif; ?>
	<?php if ($this->_tpl_vars['menu']['stockback']): ?>
      <li> <a href="javascript:;" class="nav-top-item <?php if ($this->_tpl_vars['inpath'][1] == 'stockback'): ?>current<?php endif; ?>">退货管理</a>
        <ul>
            <?php $_from = $this->_tpl_vars['menu']['stockback']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['items']):
?>
            <li><a href="<?php echo smarty_function_get_url(array('rule' => '/stockback/'), $this);?>
<?php echo $this->_tpl_vars['k']; ?>
" class="<?php if ($this->_tpl_vars['inpath'][2] == $this->_tpl_vars['k']): ?>current<?php endif; ?>"><?php echo $this->_tpl_vars['items']; ?>
</a></li>
            <?php endforeach; endif; unset($_from); ?>
...
" class="<?php if ($this->_tpl_vars['inpath'][2] == $this->_tpl_vars['k']): ?>current<?php endif; ?>"><?php echo $this->_tpl_vars['items']; ?>
	...
	<?php endif; ?>
	<?php if ($this->_tpl_vars['menu']['customer']): ?>
      <li> <a href="javascript:;" class="nav-top-item <?php if ($this->_tpl_vars['inpath'][1] == 'customer'): ?>current<?php endif; ?>">客户管理</a>
        <ul>
            <?php $_from = $this->_tpl_vars['menu']['customer']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['items']):
?>
            <li><a href="<?php echo smarty_function_get_url(array('rule' => '/customer/'), $this);?>
<?php echo $this->_tpl_vars['k']; ?>
" class="<?php if ($this->_tpl_vars['inpath'][2] == $this->_tpl_vars['k']): ?>current<?php endif; ?>"><?php echo $this->_tpl_vars['items']; ?>
</a></li>
            <?php endforeach; endif; unset($_from); ?>
