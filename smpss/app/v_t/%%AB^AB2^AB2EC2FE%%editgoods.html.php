<?php /* Smarty version 2.6.26, created on 2012-12-12 05:49:40
         compiled from simpla/goods/editgoods.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'get_url', 'simpla/goods/editgoods.html', 12, false),)), $this); ?>
...
">商品管理</a></li>
    ...
    <div class="content-box-content">
      <div class="tab-content default-tab" id="tab1">
        <div class="form">
          <form action="<?php echo smarty_function_get_url(array('rule' => '/goods/editgoods'), $this);?>
...
" class="text-input small-input" name="goods_pack_size" id="goods_pack_size" />
			  ...
			  <p>
                <label>商品图片：</label>
				<input type="file" name="goods_pic_origin" id="goods_pic" value="<?php echo $this->_tpl_vars['goods']['goods_pic']; ?>
" onchange="checkPic();"/>
				<!--<img src="<?php echo $this->_tpl_vars['goods']['goods_pic']; ?>
" height="50%" width="50%">-->
			  </p>
              <dt>
