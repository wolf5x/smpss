...
--
-- Host: localhost
-- Generation Time: Aug 19, 2012 at 05:03 PM
...
--
-- Dumping data for table `smpss_admin`
--

INSERT INTO `smpss_admin` (`admin_id`, `admin_name`, `admin_pwd`, `gid`, `createtime`, `lastlogintime`) VALUES
(6, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 1343787979, 1345302533);
...
--
-- Dumping data for table `smpss_category`
--
...
CREATE TABLE IF NOT EXISTS `smpss_config` (
  ...
  PRIMARY KEY (`key`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='退货明细';

--
-- Dumping data for table `smpss_config`
--

INSERT INTO `smpss_config` (`key`, `value`) VALUES
('last_stockin_sn', '20120818000001'),
('last_stockout_sn', '20120816500001'),
('import_stockin_template', '%stockin_sn%\r\n%goods_sn% \r\n%goods_name_chn%\r\n%goods_name_tha% \r\n%goods_pack_num%\r\n%goods_pack_size%\r\n%stockin_note%\r\n%stockin_opttime%\r\n'),
('export_stockout_template', '%stockout_sn|出库单编号%\r\n%goods_sn|商品编号%\r\n%goods_name_chn|商品名称(中)%\r\n%goods_name_tha|商品名称(泰)% \r\n%goods_pack_num|出库数量(件)%\r\n%goods_pack_size|装箱数量%\r\n%goods_unitprice|单价%\r\n%goods_totalprice|总价%\r\n%goods_note|备注%\r\n%stockout_opttime|出库时间%\r\n%customer_name|顾客名称%'),
('export_stockin_template', '%stockin_sn|入库单编号%\r\n%goods_sn|商品编号% \r\n%goods_name_chn|商品名称(中)%\r\n%goods_name_tha|商品名称(泰)% \r\n%goods_pack_num|入库数量(件)%\r\n%goods_pack_size|装箱数量%\r\n%stockin_note|备注%\r\n%stockin_opttime|入库时间%'),
('import_stockout_template', ''),
('import_stockin_template_default', '%stockin_sn%\r\n%goods_sn% \r\n%goods_name_chn%\r\n%goods_name_tha% \r\n%goods_pack_num%\r\n%goods_pack_size%\r\n%stockin_note%\r\n%stockin_opttime%\r\n'),
('export_stockout_template_default', '%stockout_sn|出库单编号%\r\n%goods_sn|商品编号%\r\n%goods_name_chn|商品名称(中)%\r\n%goods_name_tha|商品名称(泰)% \r\n%goods_pack_num|出库数量(件)%\r\n%goods_pack_size|装箱数量%\r\n%goods_unitprice|单价%\r\n%goods_totalprice|总价%\r\n%goods_note|备注%\r\n%stockout_opttime|出库时间%\r\n%customer_name|顾客名称%'),
('export_stockin_template_default', '%stockin_sn|入库单编号%\r\n%goods_sn|商品编号% \r\n%goods_name_chn|商品名称(中)%\r\n%goods_name_tha|商品名称(泰)% \r\n%goods_pack_num|入库数量(件)%\r\n%goods_pack_size|装箱数量%\r\n%stockin_note|备注%\r\n%stockin_opttime|入库时间%'),
('import_stockout_template_default', '');
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='客户数据' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `smpss_goods` (
  ...
  `goods_name_chn` varchar(100) NOT NULL COMMENT '商品名称(中)',
  `goods_name_tha` varchar(100) NOT NULL COMMENT '商品名称(泰)',
  `goods_stock` int(11) NOT NULL DEFAULT '0' COMMENT '库存(件)',
  `goods_pack_size` int(11) NOT NULL COMMENT '装箱数量',
  `goods_note` varchar(200) DEFAULT NULL COMMENT '商品备注',
  `goods_pic` mediumtext COMMENT '商品图片(BASE64编码)',
  PRIMARY KEY (`goods_id`),
  UNIQUE KEY `goods_sn` (`goods_sn`,`goods_name_chn`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品数据' AUTO_INCREMENT=5 ;

--
-- Dumping data for table `smpss_goods`
--

INSERT INTO `smpss_goods` (`goods_id`, `goods_sn`, `goods_name_chn`, `goods_name_tha`, `goods_stock`, `goods_pack_size`, `goods_note`, `goods_pic`) VALUES
(1, 'g1', 'c1', 't1', 100167, 20, '', ''),
(2, 'g2', 'c2', 't2', 32, 10, '', '/smpss/app/cache/aee95d8c87a3e0ec3d3e55b5228bdd37.jpg'),
(3, 'g1', 'c2', 't1', 0, 234, '', '/smpss/app/cache/c54c5dccd3ab551e535c6b4a69c8c375.jpg'),
(4, 'g3', 'c', 't', 2468, 33, 'hello', '');
...
CREATE TABLE IF NOT EXISTS `smpss_goods_history` (
  ...
  PRIMARY KEY (`goods_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商品临时数据';
...
--
-- Dumping data for table `smpss_group`
--

INSERT INTO `smpss_group` (`gid`, `group_name`, `action_code`, `state`) VALUES
(1, '超级管理员', 'a:3:{s:3:"all";i:0;s:6:"action";a:21:{i:0;s:12:"system_index";i:1;s:14:"system_setting";i:2;s:13:"system_rights";i:3;s:16:"system_addrights";i:4;s:13:"account_index";i:5;s:18:"account_addaccount";i:6;s:17:"account_modifypwd";i:7;s:12:"member_index";i:8;s:16:"member_addmember";i:9;s:14:"customer_index";i:10;s:20:"customer_addcustomer";i:11;s:11:"goods_index";i:12;s:14:"goods_addgoods";i:13;s:13:"stockin_index";i:14;s:15:"stockin_stockin";i:15;s:14:"stockout_index";i:16;s:17:"stockout_stockout";i:17;s:15:"stockback_index";i:18;s:19:"stockback_stockback";i:19;s:16:"statistics_index";i:20;s:16:"statistics_sales";}s:4:"menu";a:9:{s:6:"system";a:4:{s:5:"index";s:12:"系统信息";s:7:"setting";s:12:"系统配置";s:6:"rights";s:12:"权限管理";s:9:"addrights";s:15:"添加管理组";}s:7:"account";a:3:{s:5:"index";s:12:"帐号管理";s:10:"addaccount";s:12:"添加帐号";s:9:"modifypwd";s:12:"密码修改";}s:6:"member";a:2:{s:5:"index";s:12:"帐号管理";s:9:"addmember";s:12:"添加帐号";}s:8:"customer";a:2:{s:5:"index";s:12:"客户管理";s:11:"addcustomer";s:12:"添加客户";}s:5:"goods";a:2:{s:5:"index";s:12:"商品管理";s:8:"addgoods";s:12:"添加商品";}s:7:"stockin";a:2:{s:5:"index";s:15:"入库单管理";s:7:"stockin";s:12:"商品入库";}s:8:"stockout";a:2:{s:5:"index";s:15:"出库单管理";s:8:"stockout";s:12:"商品出库";}s:9:"stockback";a:2:{s:5:"index";s:15:"退货单管理";s:9:"stockback";s:12:"商品退货";}s:10:"statistics";a:2:{s:5:"index";s:12:"销售统计";s:5:"sales";s:12:"进货统计";}}}', 1),
(2, '普通管理员', 'a:3:{s:3:"all";i:0;s:6:"action";a:7:{i:0;s:12:"system_index";i:1;s:14:"system_setting";i:2;s:11:"goods_index";i:3;s:14:"goods_addgoods";i:4;s:15:"stockin_stockin";i:5;s:17:"stockout_stockout";i:6;s:18:"stockout_stockback";}s:4:"menu";a:4:{s:6:"system";a:2:{s:5:"index";s:12:"系统信息";s:7:"setting";s:12:"系统配置";}s:5:"goods";a:2:{s:5:"index";s:12:"商品管理";s:8:"addgoods";s:12:"添加商品";}s:7:"stockin";a:1:{s:7:"stockin";s:12:"商品入库";}s:8:"stockout";a:2:{s:8:"stockout";s:12:"商品出库";s:9:"stockback";s:12:"商品退货";}}}', 1),
...
--
-- Dumping data for table `smpss_log`
--
...
--
-- Dumping data for table `smpss_mbgroup`
--
...
--
-- Dumping data for table `smpss_member`
--
...
--
-- Dumping data for table `smpss_purchase`
--
...
--
-- Dumping data for table `smpss_region`
--
...
--
-- Dumping data for table `smpss_sales`
--
...
--
-- Table structure for table `smpss_stockback`
--



--
-- Dumping data for table `smpss_stockback`
--

--INSERT INTO `smpss_stockback` (`stockback_id`, `goods_sn`, `goods_name_chn`, `goods_name_tha`, `goods_pack_num`, `stockback_opttime`, `operator`, `isdel`) VALUES
--(1, 'g1', 'c1', 't1', 2, '2012-08-11 16:06:40', NULL, 0),
--(2, 'g1', 'c1', 't1', 20, '2012-08-11 16:08:11', NULL, 0),
--(3, 'g1', 'c1', 't1', 20, '2012-08-11 16:08:49', NULL, 0),
--(4, 'g1', 'c1', 't1', 2, '2012-08-11 16:12:05', NULL, 0),
--(5, 'g1', 'c1', 't1', 3, '2012-08-12 18:34:24', NULL, 0),
--(6, 'g1', 'c1', 't1', 1, '2012-08-12 18:42:38', NULL, 0),
--(7, 'g1', 'c1', 't1', 3, '2012-08-12 19:00:09', NULL, 0),
--(8, 'g1', 'c1', 't1', 1, '2012-08-12 19:33:46', NULL, 0),
--(9, 'g1', 'c1', 't1', 1, '2012-08-12 19:34:10', NULL, 0);
...
CREATE TABLE IF NOT EXISTS `smpss_stockin` (
  ...
  `goods_sn` varchar(32) NOT NULL COMMENT '商品编码',
  `goods_name_chn` varchar(100) DEFAULT NULL COMMENT '商品名称(中)',
  `goods_name_tha` varchar(100) NOT NULL COMMENT '商品名称(泰)',
  `goods_pack_num` int(11) NOT NULL DEFAULT '0' COMMENT '数量(件)',
  `goods_pack_size` int(11) NOT NULL COMMENT '装箱数量',
  `stockin_note` varchar(200) DEFAULT NULL COMMENT '入库备注',
  `stockin_opttime` datetime NOT NULL COMMENT '入库时间',
  `isdel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`stockin_sn`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='入库明细';

--
-- Dumping data for table `smpss_stockin`
--

INSERT INTO `smpss_stockin` (`stockin_sn`, `goods_sn`, `goods_name_chn`, `goods_name_tha`, `goods_pack_num`, `goods_pack_size`, `stockin_note`, `stockin_opttime`, `isdel`) VALUES
('20120801000001', 'g1', 'c1', 't1', 109, 20, '', '2012-08-01 10:27:19', 0),
('20120801000002', 'g2', 'c2', 't2', 99, 20, '', '2012-08-01 10:27:37', 0),
('20120812000001', 'g1', 'c1', 't1', 99999, 20, '', '2012-08-12 15:30:52', 0),
('20120815000001', 'g2', 'c2', 't2', 39, 20, '', '2012-08-15 23:51:28', 0),
('20120817000001', 'g1', 'c1', 't1', 99, 20, '', '2012-08-17 22:46:59', 0),
('20120818000001', 'g3', 'c', 't', 1234, 33, '', '2012-08-18 23:39:28', 0);
...
CREATE TABLE IF NOT EXISTS `smpss_stockout_detail` (
  ...
  `goods_sn` varchar(32) NOT NULL COMMENT '商品编码',
  `goods_name_chn` varchar(100) NOT NULL COMMENT '商品名称(中)，不在出库单中显示',
  `goods_name_tha` varchar(100) NOT NULL COMMENT '商品名称(泰)',
  `goods_pack_num` int(11) NOT NULL DEFAULT '0' COMMENT '数量(件)',
  `goods_pack_size` int(11) NOT NULL COMMENT '装箱数量',
  `goods_note` varchar(200) DEFAULT NULL COMMENT '出库备注',
  `goods_unitprice` float NOT NULL COMMENT '单价',
  `goods_totalprice` float NOT NULL COMMENT '总价',
  `stockout_opttime` datetime NOT NULL,
  `isdel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`stockout_detail_id`),
  UNIQUE KEY `stockout` (`stockout_sn`,`goods_sn`,`goods_name_chn`,`goods_name_tha`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='出库明细' AUTO_INCREMENT=18 ;




--
-- Dumping data for table `smpss_stockout_detail`
--

INSERT INTO `smpss_stockout_detail` (`stockout_detail_id`, `stockout_sn`, `goods_sn`, `goods_name_chn`, `goods_name_tha`, `goods_pack_num`, `goods_pack_size`, `goods_note`, `goods_unitprice`, `goods_totalprice`, `stockout_opttime`, `isdel`) VALUES
(1, 'so1', 'g1', 'c1', 't1', 10, 20, NULL, 1, 200, '2012-08-11 00:10:00', 0),
(2, 'so1', 'g2', 'c2', 't2', 9, 20, NULL, 2, 360, '2012-08-14 01:02:03', 0),
(3, '20120808500002', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 1),
(4, '20120808500003', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 0),
(5, '20120808500004', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 0),
(6, '20120808500005', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 0),
(7, '20120808500006', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 0),
(8, '20120808500007', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 0),
(9, '20120808500008', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 0),
(10, '20120808500009', 'g1', 'c1', 't1', 2, 20, '', 12, 480, '2012-08-14 01:02:03', 0),
(11, '20120808500010', 'g1', 'c1', 't1', 37, 20, '', 19.28, 14267.2, '2012-08-14 01:02:03', 1),
(12, '20120808500010', 'g2', 'c2', 't2', 78, 20, '', 7.32, 11419.2, '2012-08-14 01:02:03', 1),
(13, '20120808500011', 'g1', 'c1', 't1', 1, 20, '', 23.32, 466.4, '2012-08-14 01:02:03', 0),
(14, '20120808500011', 'g2', 'c2', 't2', 6, 20, '', 23, 2760, '2012-08-14 01:02:03', 0),
(15, '20120812500003', 'g1', 'c1', 't1', 12, 20, '', 9.99, 2397.6, '2012-08-16 01:02:03', 0),
(16, '20120816500001', 'g1', 'c1', 't1', 73, 20, '', 1.12, 1635.2, '2012-08-14 01:02:03', 0),
(17, '20120816500001', 'g2', 'c2', 't2', 31, 20, '', 9.12, 5654.4, '2012-08-14 01:02:03', 0);
...
CREATE TABLE IF NOT EXISTS `smpss_stockout_index` (
  `stockout_sn` varchar(32) NOT NULL COMMENT '出库单编号',
  `customer_name` varchar(100) NOT NULL COMMENT '客户名称',
  `stockout_opttime` datetime NOT NULL COMMENT '出库时间',
  `operator` varchar(32) DEFAULT NULL COMMENT '操作员',
  `stockout_note` varchar(200) DEFAULT NULL COMMENT '出库单备注',
  `isdel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  `goods_brief` varchar(100) DEFAULT NULL COMMENT '商品概要',
  `stockout_totalprice` float NOT NULL COMMENT '总金额',
  PRIMARY KEY (`stockout_sn`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='出库索引';

--
-- Dumping data for table `smpss_stockout_index`
--

INSERT INTO `smpss_stockout_index` (`stockout_sn`, `customer_name`, `stockout_opttime`, `operator`, `stockout_note`, `isdel`, `goods_brief`, `stockout_totalprice`) VALUES
('so1', 'cname1', '2012-08-01 10:29:26', NULL, NULL, 1, 'g1*20,g2*19', 560),
('20120808500009', 'abcd', '2012-08-08 22:14:39', NULL, '', 1, 't1*2', 480),
('20120808500010', 'abcd', '2012-08-08 22:30:36', NULL, '', 1, 't1*37, t2*78', 25686.4),
('20120808500011', 'godisabird', '2012-08-08 23:05:23', NULL, 'helloworld', 1, 't1*1, t2*6', 3226.4),
('20120812500003', 'fuck', '2012-08-12 18:23:24', NULL, '', 1, 't1*12', 2397.6),
('20120816500001', 'hhhh', '2012-08-16 00:20:36', NULL, '', 0, 't1*73t2*31', 7289.6);
...
CREATE TABLE IF NOT EXISTS `smpss_stockback_index` (
  ...
  `customer_name` varchar(100) NOT NULL COMMENT '客户名称',
  `stockback_opttime` datetime NOT NULL COMMENT '退货日期',
  `operator` varchar(32) DEFAULT NULL COMMENT '操作员',
  `stockback_note` varchar(200) DEFAULT NULL,
  `goods_brief` varchar(100) DEFAULT NULL,
  `stockback_totalprice` float DEFAULT '0',
  `isdel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`stockback_sn`)
...
CREATE TABLE IF NOT EXISTS `smpss_stockback_detail` (
  ...
  `stockback_sn` varchar(32) NOT NULL COMMENT '退货单编码',
  `goods_sn` varchar(32) NOT NULL COMMENT '商品编码',
  `goods_name_chn` varchar(100) NOT NULL,
  `goods_name_tha` varchar(100) NOT NULL COMMENT '商品名称(泰)',
  `goods_pack_num` int(11) NOT NULL DEFAULT '0' COMMENT '数量(件)',
  `goods_pack_size` int(11) NOT NULL COMMENT '装箱数量',
  `goods_note` varchar(200) DEFAULT NULL COMMENT '退货备注',
  `goods_totalprice` float NOT NULL COMMENT '总价',
  `stockback_opttime` datetime NOT NULL COMMENT '退货日期',
  `operator` varchar(32) DEFAULT NULL COMMENT '操作员',
  `isdel` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已删除',
  PRIMARY KEY (`stockback_detail_id`),
  UNIQUE KEY `stockback` (`stockback_sn`,`goods_sn`,`goods_name_chn`,`goods_name_tha`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='退货明细' AUTO_INCREMENT=10 ;
