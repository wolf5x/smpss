 ...
 * 条码图形生成类
 * 支持条码类型: 
 * EAN-13，UPC-A，ISBN，EAN-8,UPC-E,S205,I2O5,
 * INTERLEAVED,POSTNET,CODABAR,CODE128,CODE39,CODE93
 */
class SBarcode {
	var $_encode;
	var $_error;
	...
	function genBarCode($barnumber, $format = "gif", $scale, $file = "") {
	...
	*/
	...
	function _c39Encode($barnumber, $checkdigit = false) {
		$encTable = array ("0" => "NNNWWNWNN", "1" => "WNNWNNNNW", "2" => "NNWWNNNNW", "3" => "WNWWNNNNN", "4" => "NNNWWNNNW", "5" => "WNNWWNNNN", "6" => "NNWWWNNNN", "7" => "NNNWNNWNW", "8" => "WNNWNNWNN", "9" => "NNWWNNWNN", "A" => "NNWWNNWNN", "B" => "NNWNNWNNW", "C" => "WNWNNWNNN", "D" => "NNNNWWNNW", "E" => "WNNNWWNNN", "F" => "NNWNWWNNN", "G" => "NNNNNWWNW", "H" => "WNNNNWWNN", "I" => "NNWNNWWNN", "J" => "NNNNWWWNN", "K" => "WNNNNNNWW", "L" => "NNWNNNNWW", "M" => "WNWNNNNWN", "N" => "NNNNWNNWW", "O" => "WNNNWNNWN", "P" => "NNWNWNNWN", "Q" => "NNNNNNWWW", "R" => "WNNNNNWWN", "S" => "NNWNNNWWN", "T" => "NNNNWNWWN", "U" => "WWNNNNNNW", "V" => "NWWNNNNNW", "W" => "WWWNNNNNN", "X" => "NWNNWNNNW", "Y" => "WWNNWNNNN", "Z" => "NWWNWNNNN", "-" => "NWNNNNWNW", "." => "WWNNNNWNN", " " => "NWWNNNWNN", "$" => "NWNWNWNNN", "/" => "NWNWNNNWN", "+" => "NWNNNWNWN", "%" => "NNNWNWNWN", "*" => "NWNNWNWNN" );
	...
	*/
	 ...
	 * ean13校验码
	 */
	function _ean13CheckDigit($number) {
		//如果小于12位报错
		if (strlen ( $number ) < 12) {
			echo 'error 1542 this string cant short than 12';
			exit ();
		}
		;
		//等于12位，添加校验码
		...
		//大于13位报错
		if (strlen ( $number ) > 13) {
			echo 'error 1563 this string length cant longer than 13';
			exit ();
		}
		return $result;
	}
